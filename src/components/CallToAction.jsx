...
export function CallToAction() {
  return (
    <Container className="mb-10 justify-center mx-auto max-w-2xl lg:max-w-4x px-100">
      <hr />
      ...
      <form className='mt-24'>
        <div className="space-y-12">
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
            <div>
              <h2 className="text-2xl  font-semibold leading-7 text-gray-900">Need something else?</h2>
