...
export default function BlogPost() {
  return (
    <>
      <Header />
      <div className="flex max-w-full"> {/* Wrapper div */}
        <div className="md:grid md:grid-cols-10 items-center ">
          <div className="md:col-span-7 bg-white px-6 py-32 lg:px-8 border-r border-spacing-3 ">
          ...
          <div className='md:col-span-3'>
            <div className="mx-auto mt-16 grid max-w-2xl gap-x-8 gap-y-5 lg:mx-8 grid-cols-1 pr-8">
              <p>
                Other blog posts
              </p>
              <BlogSection />
